...
export const COURSES: Course[] = [
  // ─── 轻度课程 ────────────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'e3', name: '左侧屈拉伸', description: '头部向左侧倾斜，右肩保持放松下沉。', durationSeconds: 20, motionType: 'left' },
      { id: 'e4', name: '右侧屈拉伸', description: '头部向右侧倾斜，左肩保持放松下沉。', durationSeconds: 20, motionType: 'right' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'e11', name: '斜方肌拉伸', description: '右手轻压头部左侧，感受斜方肌拉伸，保持均匀呼吸。', durationSeconds: 25, motionType: 'left' },
    ],
  },
  ...
  // ─── 中度课程 ────────────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'm3', name: '左侧屈深度拉伸', description: '头部向左侧倾斜至最大幅度，右手自然下垂，保持15秒。', durationSeconds: 35, motionType: 'left' },
      { id: 'm4', name: '右侧屈深度拉伸', description: '头部向右侧倾斜至最大幅度，左手自然下垂，保持15秒。', durationSeconds: 35, motionType: 'right' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'me2', name: '胸锁乳突肌拉伸左', description: '头部向右旋转并轻微后仰，感受左侧颈前肌群拉伸，保持20秒。', durationSeconds: 30, motionType: 'left' },
      { id: 'me3', name: '胸锁乳突肌拉伸右', description: '头部向左旋转并轻微后仰，感受右侧颈前肌群拉伸，保持20秒。', durationSeconds: 30, motionType: 'right' },
      { id: 'me4', name: '斜方肌深度拉伸', description: '右手轻压头部左侧，左手向下伸展，感受斜方肌充分拉伸，保持25秒。', durationSeconds: 35, motionType: 'left' },
  ...
  // ─── 重度课程 ────────────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      ...
      { id: 'i4', name: '侧屈深度拉伸（左）', description: '头部向左侧倾斜，右手向下伸展，保持20秒，重复3次。', durationSeconds: 70, motionType: 'left' },
      { id: 'i5', name: '侧屈深度拉伸（右）', description: '头部向右侧倾斜，左手向下伸展，保持20秒，重复3次。', durationSeconds: 70, motionType: 'right' },
      ...
      { id: 'i9', name: '斜方肌深度拉伸（双侧）', description: '左右各深度拉伸斜方肌，每侧保持30秒，配合深呼吸。', durationSeconds: 75, motionType: 'shoulder' },
      { id: 'i10', name: '颈部神经松动（左）', description: '头部向右侧倾斜，左臂向下伸展并缓慢弯曲手腕，感受神经轻微拉伸。', durationSeconds: 50, motionType: 'left' },
      { id: 'i11', name: '颈部神经松动（右）', description: '头部向左侧倾斜，右臂向下伸展并缓慢弯曲手腕，感受神经轻微拉伸。', durationSeconds: 50, motionType: 'right' },
